...
```bash
ae-cli analysis project role delete --project-id <project_id> --role-name <role_name> --new-role-name <new_role_name>
ae-cli analysis project role delete --dry-run --project-id <project_id> --role-name <role_name>
```
