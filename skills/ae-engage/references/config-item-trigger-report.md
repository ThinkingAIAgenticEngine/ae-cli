...
Query config item publish and trigger trends through the L3 Capability Gateway.

Mapped command: `ae-cli capability run engage-scene.report.config-item-trigger --input '<json>'`
