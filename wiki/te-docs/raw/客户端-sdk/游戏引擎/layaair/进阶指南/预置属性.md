---
code: laya_sdk_preset_properties
name: "预置属性"
wikiToken: DMqZwQ99BiC53vkE30ochUY7nqd
parentWikiToken: UGaFwQQPEi69XukGdVocvRTSnjh
updateTime: 1776262602000
sourceUrl: https://docs-v2.thinkingdata.cn/?version=v6.0&lan=zh-CN&code=laya_sdk_preset_properties
---
...
<lark-table rows="3" cols="4" column-widths="243,243,100,243">
  ...
  <lark-tr>
    ...
    <lark-td>
      内容为JSON字符串，是从`getLaunchOptionsSync`接口获取的参数
    </lark-td>
  </lark-tr>
</lark-table>
