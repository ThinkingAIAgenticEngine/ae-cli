---
code: mp_sdk_preset_properties
name: "预置属性"
wikiToken: CMS2whzzQinG3nkHGgAcebWAnqf
parentWikiToken: UfaMw00cqizIHQkdo1wccqJYnBf
updateTime: 1776262640000
sourceUrl: https://docs-v2.thinkingdata.cn/?version=v6.0&lan=zh-CN&code=mp_sdk_preset_properties
---
## 一、所有事件的预置属性
以下预置属性，是小程序/小游戏 SDK 中所有事件（包括自动采集事件）都会带有的预置属性

<lark-table rows="20" cols="4" column-widths="243,243,100,243">
...
<lark-table rows="2" cols="4" column-widths="243,243,100,243">
  ...
  <lark-tr>
    ...
    <lark-td>
      表示本次启动`ta_mp_show`到隐藏`ta_mp_hide`的持续时长，单位是秒
    </lark-td>
  </lark-tr>
</lark-table>
