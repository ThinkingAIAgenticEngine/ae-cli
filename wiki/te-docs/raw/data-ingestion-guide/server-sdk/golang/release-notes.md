---
code: golang_sdk_release_note
name: "Release Notes"
wikiToken: ZFjHwWkeciXZDnk0VTHcByVDnYc
parentWikiToken: GVHiwdEmWixRWrk0ZdKcT2twnSn
updateTime: 1774249262000
sourceUrl: https://docs-v2.thinkingdata.cn/?version=v6.0&lan=en-US&code=golang_sdk_release_note
---
...
**Date: 2024/10/15**
**Notes:**
- Support setting app id in data
## v2.0.1
**Date: 2024/01/04**
**Notes:**
- Add panic catch
...
**Date: 2023/09/22**
**Notes:**
- Use the SetLogLevel() method to enable log
## v1.7.0
**Date: 2023/07/24**
**Notes:**
