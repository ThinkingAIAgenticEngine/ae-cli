...
const SKILL_NAMES = ['ae-generate-tracking-plan', 'ae-generate-tracking-code', 'ae-migrate-tracking-code', 'ae-data-integration', 'ae-data-integration-helper'] as const;
