...
/** Creates a custom client-side parameter for a project, including its type, select mode, and display metadata. */
export const clientParamCreate = createEngageSettingCapabilityCommand({
  ...
  description: 'Create a custom client-side parameter for a project, including its type, select mode, and display metadata.',
  flags: [
    ...
    { name: 'column-source', type: 'string', required: false, desc: 'Param source: preset or custom. Defaults to custom.' },
