...
export const metadataVirtualEventCreate = createAnalysisMetaCapabilityCommand({
  ...
  flags: [
    ...
    { name: 'events', type: 'json', required: false, desc: 'Event array using snake_case event_name and optional AI-facing filter conditions. Tag/cluster conditions accept cluster_date_policy and specified_cluster_date.' },
    { name: 'filter', type: 'json', required: false, desc: 'Optional AI-facing global filter. Tag/cluster conditions accept LATEST, AUTO, or SPECIFIED; SPECIFIED requires specified_cluster_date. Raw taFilters/junctionKind are rejected.' },
